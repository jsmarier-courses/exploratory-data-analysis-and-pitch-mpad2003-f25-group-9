...
The most challenging part of this assignment for our group was communication. Aside from deciding roles at the start, we did not share many ideas together, and generally worked individually on our designated parts. Another challenge would be finding secondary references, as for the majority of the assignment we had been able to simply use the methods learned in class, and some group members had prior knowledge of Google Sheets, specifically utilizing certain functions, which, as a result, did involve the use of any references.

The most rewarding aspect is seeing the completed webpage, as it looks as we had pictured and is a fun and unique way to present a mostly written project. This webpage version of what we see as code visibly demonstrates how our work behind the scenes in VSCode is seen to viewers from the outside, accessing it through something more typically seen online, like a website. 

Finally, reviewing functions in Google Sheets was very necessary for this project as I had realized my knowledge was lacking since the last time I used Google Sheets for something other than my own planning.

Overall, for similar assignments in the future better communication and collaboration are key to create a sense of connection between individually assigned sections, and overall more of a collaborative group project with equal workloads. 
